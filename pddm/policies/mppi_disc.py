...
#             eps_higherRange = (
#                 np.random.normal(
#                     loc=0, scale=1.0, size=(self.N, self.horizon, self.ac_dim)
#                 )
#                 * self.sigma
#             )
...
#             eps_lowerRange = (
#                 np.random.normal(
#                     loc=0, scale=1.0, size=(num_lowerRange, self.horizon, self.ac_dim)
#                 )
#                 * lowerRange
#             )
...
#             if i == 0:
#                 all_samples[:, i, :] = (
#                     self.beta * (self.mppi_mean[i, :] + eps[:, i, :])
...
#         all_acs = turn_acs_into_acsK(
#             actions_taken_so_far, all_samples, self.K, self.N, self.horizon
#         )
...
#             )
#             """all_acs.shape: [N, horizon, K, action_dim]"""
...
#         """execute_sideRollouts: candidate action sequences with GT dynamics."""
...
#                         ###if(step_number%10==0):
#                         plt.plot(
#                             resulting_states_list[-1][:, sim_num, index_state_to_vis],
#                             "--",
#                             c=color,
#                             label=sim_num,
#                         )
#                         plt.plot(
#                             np.array(true_states)[:, index_state_to_vis], "-", c=color
#                         )
#                     curr_plot += 1
