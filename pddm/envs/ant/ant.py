...
class AntEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def get_reward(self, observations, actions):
        ...
        # calc rew
        self.reward_dict["actions"] = -self._ctrl_cost_weight * np.sum(
            np.square(actions), axis=1
        )
        ...
        self.reward_dict["r_total"] = (
            ...
            + self.reward_dict["health"]
            + self.reward_dict["flipping"]
        )  ### + self.reward_dict['actions']
