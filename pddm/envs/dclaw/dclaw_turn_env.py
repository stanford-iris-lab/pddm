...
class DClawTurnEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self, n_jnt=9, n_obj=1, frame_skip=40):
        ...
        super().__init__(
            ...
            camera_settings=dict(distance=1.0, azimuth=140, elevation=-50,),
        )
        ...
        self.act_rng = 0.5 * (
            self.model.actuator_ctrlrange[: self.n_jnt, 1]
    ...
    def get_reward(self, observations, actions):
        ...
        self.reward_dict["r_total"] = (
            self.reward_dict["r_target_dist"]
